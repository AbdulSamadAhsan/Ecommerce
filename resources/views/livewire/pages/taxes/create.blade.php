...
<div>
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold mb-1">Add Tax</h3>
            <p class="text-muted mb-0">Create a percentage or fixed tax rule.</p>
        </div>
            ...
            <form wire:submit.prevent="save">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" wire:model.live="name" class="form-control rounded-pill" placeholder="GST, VAT, Service Tax">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" wire:model.live="rate" class="form-control rounded-pill" placeholder="17">
                        @error('rate') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>

                    <div class="col-md-12">
                        <label class="form-label fw-semibold">Description</label>
                        <textarea wire:model.live="description" class="form-control rounded-4" rows="4" placeholder="Optional tax description"></textarea>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary rounded-pill px-4">
                        <span wire:loading.remove wire:target="save">Save Tax</span>
