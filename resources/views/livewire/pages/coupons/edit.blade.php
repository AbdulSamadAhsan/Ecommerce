...
new #[Layout('layouts.app')] class extends Component {
    ...
    {
        return [
            'code' => ['required', 'string', 'min:2', 'max:100', 'unique:coupons,code,' . $this->couponId],
...
<div>
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Update coupon details and discount rules.</p>
        </div>
            ...
            <form wire:submit.prevent="update">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" wire:model.live="code" class="form-control rounded-pill">
                        @error('code') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>

                    <div class="col-md-8">
                        <label class="form-label fw-semibold">Title</label>
                        <input type="text" wire:model.live="title" class="form-control rounded-pill">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" wire:model.live="discount_value" class="form-control rounded-pill">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" wire:model.live="minimum_order_amount" class="form-control rounded-pill">
